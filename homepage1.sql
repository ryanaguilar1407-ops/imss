...
# Username (we allow either name or email at login)
...
# Login Function (now uses the sqlite database)
def login():
...
position_option.set("Staff")  # sensible default

# Signup Button (now persists to the database)
def signup():
    ...
    try:
        ...
        show_login()
        # Optionally pre-fill the username/email field
